  ...
  Widget build(BuildContext context) {
    return BlocConsumer<UserCubit, UserState>(
      ...
      builder: (context, state) {
        UserCubit ob = UserCubit.get(context);
        return Scaffold(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    Gap(15.h),
                    EmailTextffWidget(
                      emailController: ob.emailController,
                    ...
                    Gap(15.h),
                    PasswordTextffWidget(
                      passwordController: ob.passwordController,
                    ...
                    state is LoginLoadingState ? const CircularProgressIndicator() : MainElevatedButton(
                      label: 'Login',
                      onPressed: () {
                        ob.signIn();
