...
const Color cDarkWhiteColor = Color(0xffF0F7FF);
const Color cBlackColor = Color(0xff041116);
const Color cLightBlackdColor = Color(0xff09242E);
const Color cPrimaryDarkColor = Color(0xFF30637C);
const Color cPrimaryColor = Color(0xFF478FB4);
